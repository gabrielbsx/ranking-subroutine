...
export const StructSubCelestial = struct({
  ...
  learnedSkill: array(ref.types.int, 2),
...
export const StructMobExtra = struct({
  ...
  secondLearnedSkill: ref.types.int,
  fame: ref.types.int,
  soul: ref.types.byte,
  ...
  lastNT: ref.types.longlong,
  nt: ref.types.int,
  kefraTicket: ref.types.int,
  divineEnd: ref.types.longlong,
  revigorante: ref.types.longlong,
  checkTimeKersef: ref.types.int,
  hold: ref.types.uint,
  sephira: ref.types.longlong,
  saude: ref.types.longlong,
